...
$telimleraxtar=$db->prepare("SELECT * FROM telimler where telim_id=:telim_id");
$telimleraxtar->execute(array(
	'telim_id' => $_GET['telim_id']
	));

$telimlercek=$telimleraxtar->fetch(PDO::FETCH_ASSOC);

echo$say=$telimleraxtar->rowCount();

if ($say==0) {
	
	header("Location:index.php?status=oynasma");
	exit;
}
?>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-9"><!--Main content-->
			<div class="title-bg">
				<div class="title"><?php echo $telimlercek['telim_ad'] ?></div>
			</div>
			<div class="row">
				<div class="col-md-6">
