          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Menu Məlumatı <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <select id="heard" class="form-control" name="active" required>
                   ...
                   <!-- Kısa İf Kulllanımı 
                    ...
                    <?php echo $menucek['active'] == '1' ? 'selected=""' : ''; ?>
                  ...
                  <option value="1" <?php echo $menucek['active'] == '1' ? 'selected=""' : ''; ?>>Aktiv</option>



                  <option value="0" <?php if ($menucek['active']==0) { echo 'selected=""'; } ?>>Passiv</option>
             ...
             <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="menuduzenle" class="btn btn-success">Dəyişdir</button>
              </div>
            </div>
