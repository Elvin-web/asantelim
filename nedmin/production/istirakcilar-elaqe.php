        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
                    ...
                    <form class="form-horizontal form-label-left input_mask" action="istirakcilar.php">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback"><label>Facebook: </label>
                          <a href="https://www.facebook.com/<?php echo $istirakcicek['istirakci_facebook'] ?>"> <button type="submit"  class="btn btn-success">
                        <?php echo $istirakcicek['istirakci_facebook'] ?></button></a> 
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <a href="istirakcilar.php"> <button type="submit"  class="btn btn-danger">Çıx</button></a> 
                        </div>
                      </div>
